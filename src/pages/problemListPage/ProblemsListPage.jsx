...
const ProblemsListPage = () => {
     ...
     const topics = useMemo(() => categories.find(category => category.id === categoryId)?.topicList || [], [categories]);

     useEffect(() => {
          setTopicId(topics[0]?.id)
     }, [topics])

     const { data: questions = [], isFetching: isFetchingQuestions, } = useGetQuestionsByTopicQuery(topicId, {
          skip: !topicId
     });
