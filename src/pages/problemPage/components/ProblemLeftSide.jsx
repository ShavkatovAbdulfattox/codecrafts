...
import { getQuestionDifficulty, getUserData } from "../../../utils/functions";
...
import { useDislikeMutation, useLikeMutation } from "../../../services/questionApi";
    ...
    const items = [
        {
            ...
            children: (
                <div className="left-side__body">
                    <h1>{question.name} {isLiking || isDisliking ? <Spin style={{ marginInlineStart: "10px" }} /> : ""} </h1>
                    <div className="left-side__info">
                        ...
                        <button
                            className="left-side__dislike"
                            onClick={onGiveDislike}
                        >
                            <DislikeButton />
